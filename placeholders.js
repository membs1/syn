...
async function loadData() {
    firstNames = await loadFromFile('fnames.txt');
    lastNames = await loadFromFile('lnames.txt');
    companyNames = await loadFromFile('companyNames.txt');
    linksArray = await loadFromFile('links.txt');
    wordsArray = await loadFromFile('words.txt');
}
...
module.exports = {
    replacePlaceholders,
    loadData // Export loadData to ensure it can be awaited in main.js
};
